...
"<form action='/0wifi'   method='get'><button>WLAN ohne Scan konfigurieren</button></form><br/>\n", // MENU_WIFINOSCAN
...
//  "</table>"
 "<p>WifiWhirl <a href='https://wifiwhirl.de'>https://wifiwhirl.de</a>";
#else
const char HTTP_HELP[]             PROGMEM = "";
#endif
...
const char S_exiting[]            PROGMEM = "Beenden";
